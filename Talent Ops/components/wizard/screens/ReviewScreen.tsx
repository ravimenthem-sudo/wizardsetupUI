                ...
                <div className="bg-white rounded-[40px] border border-mist/30 p-10 shadow-sm relative">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <div className="font-accent text-[8px] font-bold uppercase tracking-[0.2em] text-graphite-light opacity-40 mb-1">Size</div>
                                <div className="font-body text-sm font-bold text-ink">{config.companyInfo.size || '---'}</div>
                            </div>
                            <div>
                                ...
                                <div className="font-body text-sm font-bold text-ink">{config.companyInfo.industry || '---'}</div>
                            </div>
                        </div>

                        <div>
                            <div className="font-accent text-[8px] font-bold uppercase tracking-[0.2em] text-graphite-light opacity-40 mb-1">Admin Email</div>
                            <div className="font-body text-sm font-bold text-ink">{config.companyInfo.website || '---'}</div>
                        </div>
                    </div>
                </div>
