...
export default function Footer() {
    return (
        <footer className="bg-ink text-paper py-12 px-8 md:px-16 border-t border-graphite/20">
            <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul className="flex flex-row flex-wrap gap-4 font-body text-sm text-mist/60">
                        <li><Link href="#alignment" className="hover:text-accent-violet transition-colors">Alignment</Link></li>
                        <li><Link href="#performance" className="hover:text-accent-violet transition-colors">Performance</Link></li>
                        <li><Link href="#growth" className="hover:text-accent-violet transition-colors">Growth</Link></li>
                        <li><Link href="#people" className="hover:text-accent-violet transition-colors">People</Link></li>
                    </ul>
                </div>
            ...
            <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-graphite/30 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-accent text-graphite-light tracking-wider uppercase">
