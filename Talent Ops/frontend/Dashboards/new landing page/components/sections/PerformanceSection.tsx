...
export default function PerformanceSection() {
    ...
    return (
        ...
        >
            ...
            <div className="perf-bg-text absolute bottom-[-5%] right-[-5%] font-display text-[clamp(8rem,25vw,20rem)] font-black leading-none text-ink-soft opacity-30 pointer-events-none select-none">
                METRICS
            </div>
        </section>
    )
