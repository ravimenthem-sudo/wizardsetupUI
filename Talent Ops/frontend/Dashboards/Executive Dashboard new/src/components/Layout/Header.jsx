...
const Header = () => {
    ...
    const searchData = [
        // Employees
        { id: 1, type: 'Employee', title: 'Alice Johnson', subtitle: 'Engineering', path: '/employees', icon: User },
        { id: 2, type: 'Employee', title: 'Bob Smith', subtitle: 'Engineering', path: '/employees', icon: User },
        { id: 3, type: 'Employee', title: 'Charlie Brown', subtitle: 'Design', path: '/employees', icon: User },
        // Tasks
